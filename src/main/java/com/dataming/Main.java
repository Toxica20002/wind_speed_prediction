...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        for (Classifier classifier : classifiers) {
            ...
            System.out.println("=====================================");
            results[0][1] = String.format("%.5f", eval.correlationCoefficient());
            results[1][1] = String.format("%.5f", eval.meanAbsoluteError());
            results[2][1] = String.format("%.5f", eval.rootMeanSquaredError());
            results[3][1] = String.format("%.5f", eval.relativeAbsoluteError()) + "%";
            results[4][1] = String.format("%.5f", eval.rootRelativeSquaredError()) + "%";
            results[5][1] = String.valueOf((int) eval.numInstances());
            results[6][1] = timeTaken + "ms";
            System.out.println(AsciiTable.getTable(results));
        }
